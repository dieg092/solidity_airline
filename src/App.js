...
export class App extends Component {
    ...
    async getBalance() {
      let waiBalance = await this.web3.eth.getBalance(this.state.account);
      this.setState({
        balance: this.toEther(waiBalance)
      });
    }
            ...
            <div className="row">
                ...
                <div className="col-sm">
                    <Panel title="Loyalty points - refundable ether">
                      ...
                      <button className="btn btn-sm btn-success text-white" onClick={this.refoundLoyaltyPoints.bind(this)}>Refund</button>
                    </Panel>
                </div>
            </div>
            <div className="row">
